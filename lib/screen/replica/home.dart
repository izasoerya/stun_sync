...
class HomePageReplica extends ConsumerStatefulWidget {
  const HomePageReplica({super.key});

  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends ConsumerState<HomePageReplica> {
  Timer? _timer;
  void _updateState() {
    setState(() {});
  }

  double _bmiFormula(double weight, double height) {
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  ValueContainer(
                                      value: (_bmiFormula(7.61, 74) * 10e3)
                                          .toStringAsFixed(2)),
                                  const Spacer(),
                                  const Column(
                                    children: [
